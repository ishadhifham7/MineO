  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.subHeaderText}>Small reflection builds long-term clarity</Text>
        <Text style={styles.description}>
          Progress does not need to be loud. Start with one moment, one habit, one goal.
        </Text>
      </View>
