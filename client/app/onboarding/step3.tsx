    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 40 }}>
           ...
           {/* Dots representation */}
           {[1, 2, 3, 4].map((i) => (
             <View key={i} style={{ width: 12, height: 12, borderRadius: 6, backgroundColor: i === 4 ? '#000' : '#D1D1C4', marginHorizontal: 15 }} />
           ))}
        </View>

        <Text style={styles.description}>
          Life moments—both challenging and meaningful—form your personal narrative. Reflection helps you understand where you've been and where you're heading.
        </Text>
      </View>
      {/* Footer similar to Step 2, but with 3 active bars */}
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  diagramContainer: { width: '100%', padding: 20, backgroundColor: '#E8E8D9', borderRadius: 8, marginVertical: 30, alignItems: 'center' },
